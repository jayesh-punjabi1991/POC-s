...
require.config({
    ...
    paths: {
        ...
        'sockjs':"../bower_components/sockjs-client/dist/sockjs-1.1.1.min",
        'stompjs':"../bower_components/stomp-websocket/stomp.min",
        'ng-stomp':'../bower_components/ng-stomp/dist/ng-stomp.min',
    ...
    shim: {
        ...
        'sockjs':['angular'],
        'stompjs':['angular', 'sockjs'],

        'ng-stomp':['angular','sockjs','stompjs'],
        'app': {
            deps: ['angular', 'ngMap']
        },
        'highcharts': {
