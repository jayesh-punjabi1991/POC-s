...
function nextRecord(autoId,recordId){	
	document.getElementById("prNumeber").value="";
var flag="Next";
...
function searchPRNumberRecort(){	
		var prNumber = document.getElementById("prNumeber").value;
		var timeStamp= document.getElementById("timeStamp").value;
		if(prNumber==""){
			alert("Please enter PR Number.");
			return false;
		}else{	
			document.forms[0].action="getPRRecords.jpage?timeStamp="+timeStamp+"&prNumber="+prNumber;
			document.forms[0].submit();	   	    
		}
	}
